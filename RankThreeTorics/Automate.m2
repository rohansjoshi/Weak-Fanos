...
-- Testing function to check if varieties are isomorphic
-- Zhengning's examples, and the Picard rank 2 example
...
areIsomorphic(X1, X2) -- should be true
...
areIsomorphic(X3, X4) -- should be false

areIsomorphic(kleinschmidt(3, {0}), kleinschmidt(3, {0,0})) -- should be true
areIsomorphic(kleinschmidt(3, {0}), kleinschmidt(3, {0, 1})) -- should be false